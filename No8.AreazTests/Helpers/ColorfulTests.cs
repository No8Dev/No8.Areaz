...
public class ColorfulTests
{
    ...
    bool AlmostEqual(double v1, double v2, double eps = Delta)
    {
    ...
    readonly FColorValues[] _values = new[] {
    ...
    private readonly ShortHexValue[] _shortHexValues = new[]
    {
    ...
    {
        foreach (var tt in _values)
        {
            var (r, g, b, a) = tt.C.AsRGBA();

            Assert.AreEqual(tt.RGBA[0], r);
            Assert.AreEqual(tt.RGBA[1], g);
            Assert.AreEqual(tt.RGBA[2], b);
            Assert.AreEqual(tt.RGBA[3], a);
    ...
    public void TestRGB255Conversion()
    {
        foreach (var tt in _values)
        {
            ...
            Assert.AreEqual(tt.RGB255[0], r);
            Assert.AreEqual(tt.RGB255[1], g);
            Assert.AreEqual(tt.RGB255[2], b);
        }
    }
    ...
    public void TestHsvConversion()
    {
        foreach (var tt in _values)
        {
            ...
            Assert.AreEqual(tt.HSV[0], h);
            Assert.AreEqual(tt.HSV[1], s);
            Assert.AreEqual(tt.HSV[2], v);
        }
    }
    ...
    public void TestHslConversion()
    {
        foreach (var tt in _values)
        {
            ...
            Assert.AreEqual(tt.HSL[0], h);
            Assert.AreEqual(tt.HSL[1], s);
            Assert.AreEqual(tt.HSL[2], l);
        }
    }
    ...
    {
        foreach (var tt in _shortHexValues)
        {
            var (c, err) = Colorful.CreateHex(tt.Hex);
    ...
    [Test]
    [Ignore("Algorithm Fast, but test is slow")]
    ...
    struct Distance
    {
        public readonly Colorful c1;
        public readonly Colorful c2;
        public readonly double d76;
        public readonly double d94;
    ...
    private readonly Distance[] _distances = new Distance[]
    {
    ...
    public void TestColor()
    {
        ...
        Assert.AreEqual(45, g);
        Assert.AreEqual(67, b);
    }
    ...
    public void TestColorGray()
    {
        ...
        Assert.AreEqual(0x80, r);
        Assert.AreEqual(0x80, g);
    ...
    private readonly AngleValue[] angleValues = new AngleValue[]
    {
    ...
    {
        foreach (var tt in angleValues)
        {
            var actual = Colorful.InterpolateAngle(tt.a0, tt.a1, tt.t);

            Assert.AreEqual(tt.at, actual);
        }
    }
    ...
    public void TestInterpolationBackwards()
    {
        foreach (var tt in angleValues)
        {
            var actual = Colorful.InterpolateAngle(tt.a1, tt.a0, 1.0 - tt.t);
