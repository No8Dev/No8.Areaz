...
public static class Conn
{
    ...
    static Conn()
    {
        ...
        // ReSharper disable once RedundantDelegateCreation - This fixes an odd bug in dotnet
        System.Console.CancelKeyPress += new ConsoleCancelEventHandler(ConsoleCancelEventHandler);
        _alive = true;
