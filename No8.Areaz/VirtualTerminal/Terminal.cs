namespace No8.Areaz.VirtualTerminal;

/// <summary>
///     Terminal is a class containing pre-defined terminal sequences.
///     These sequences are used to update
///     <see cref="https://invisible-island.net/xterm/ctlseqs/ctlseqs.htm"/>
///     <see cref="https://en.wikipedia.org/wiki/ANSI_escape_code"/>
///     <see cref="https://docs.microsoft.com/en-us/windows/console/console-virtual-terminal-sequences"/>
///     <see cref="https://vt100.net/docs/vt100-ug/chapter3.html#S3.3"/>
///     <see cref="https://espterm.github.io/docs/"/>
///     <see cref="https://www.xfree86.org/current/ctlseqs.html"/>
///     <see cref="https://vt100.net/dec/ek-vt520-rm.pdf"/>
/// </summary>
/// <remarks>
/// Escape Sequence
///     ESC                 0x1b
...
public static class Terminal
{
    ...
    public static class TextProcessing
    {
        ...
        // DECAWM
        public static string SetAutoWrapMode() => "\x1b[?7h";
        public static string ResetAutoWrapMode() => "\x1b[?7l";
    }
    ...
    public static class Cursor
    {
        ...
        public static string NextLine(int n = 1) => n == 1 ? "\x1b[E" : $"\x1b[{n}E";  // CNL cursor next line
        public static string PrevLine(int n = 1) => n == 1 ? "\x1b[F" : $"\x1b[{n}F";  // CPL cursor prev line
        
        public static string HorizontalAbsolute(int n = 1) => n == 1 ? "\x1b[G" : $"\x1b[{n}G"; // CHA cursor horizontal absolute
        public static string RightTab(int n = 1) => n == 1 ? "\x1b[I" : $"\x1b[{n}I"; // CHT cursor horizontal tabulation
        public static string LeftTab(int n = 1) => n == 1 ? "\x1b[Z" : $"\x1b[{n}Z";  // CBT cursor backwards tabulation

        public static string Show => "\x1b[?25h";
        public static string Hide => "\x1b[?25l";

        public static string Save => "\x1b7";
        public static string Restore => "\x1b8";
        ...
        /// </param>
        public static string SetCursorStyle(string value) => $"\x1b[{value} q"; // CSI Ps SP q
    }
    ...
    public static class Graphics
    {
        ...
        public static string OverlineOn => "\x1b[53m";      // Overlined
        public static string OverlineOff => "\x1b[55m";     // Overlined off
    ...
    public static class ControlSeq
    {
        ...
        /// </param>
        /// <param name="x">First parameter (optional)</param>
        /// <param name="y">Second parameter (optional)</param>
        ...
        ///     <para>0  ⇒  Set window/icon labels using hexadecimal.</para>
        ///     <para>1  ⇒  Query window/icon labels using hexadecimal.</para>
        ///     <para>2  ⇒  Set window/icon labels using UTF-8.</para>
        ///     <para>3  ⇒  Query window/icon labels using UTF-8.  (See discussion of Title Modes)</para>
        /// </param>
        ...
        /// </summary>
        /// <param name="top">Top line. Default is 1</param>
        /// <param name="left">Left colum. Default is 1</param>
        /// <param name="bottom">Bottom line. Default is last line in active page</param>
        /// <param name="right">Right column. Default is last column in active page</param>
        /// <param name="Ps">
        ///     <para>0 => Reverse all attributes (default)</para>
        ///     <para>1 => Reverse bold attribute</para>
        ///     <para>4 => Reverse underline attribute</para>
        ///     <para>5 => Reverse blink attribute</para>
        ///     <para>7 => Reverse reverse attribute</para>
        /// </param>
        ...
        /// <param name="Ps">
        ///     <para>0  ⇒  error.</para>
        ///     <para>1  ⇒  cursor information report (DECCIR).</para>
        ///     <para>Response is DCS 1 $ u Pt ST</para>
        ///     Refer to the VT420 programming manual, which requires six pages to document the data string Pt,
        ///     <para>2  ⇒  tab stop report (DECTABSR).</para>
        ///     <para>Response is DCS 2 $ u Pt ST</para>
        /// 
        ...
        /// </summary>
        /// <param name="Ps">
        ///     <para>if Ps is a "0" (default) or "1", and xterm is emulating VT100, the control sequence elicits a response of the 
        ///     same form whose parameters describe the terminal:</para>
        ///         Ps ⇒  the given Ps incremented by 2.
        ///         <para>1  =>  no parity.</para>
        ///         <para>1  =>  eight bits.</para>
        ///         <para>1  =>  2 8  transmit 38.4k baud.</para>
        ///         <para>1  =>  2 8  receive 38.4k baud.</para>
        ///         <para>1  =>  clock multiplier.</para>
        ///         <para>0  =>  STP flags.</para>
        /// </param>
        ...
        /// </summary>
        /// <param name="Ps">
        ///     <para>0  ⇒  from start to end position, wrapped.</para>
        ///     <para>1  ⇒  from start to end position, wrapped.</para>
        ///     <para>2  ⇒  rectangle (exact).</para>
        /// </param>
        ...
        /// <param name="bottom">Bottom line. Default is last line in active page</param>
        /// <param name="right">Right column. Default is last column in active page</param>
        public static string FillArea(string ch, string top, string left, string bottom, string right)
        {
            return $"\x1b[{ch};{top};{left};{bottom};{right}$x";
        ...
        /// </summary>
        /// <param name="Ps">
        ///     <para>0  ⇒  Locator disabled (default).</para>
        ///     <para>1  ⇒  Locator enabled.</para>
        ///     <para>2  ⇒  Locator enabled for one report, then disabled.</para>
        /// </param>
        /// <param name="Pu">
        /// Specifies the coordinate unit for locator reports.
        ///     <para>0  =>  default to character cells (default).</para>
        ///     <para>1  =>  device physical pixels.</para>
        ///     <para>2  =>  character cells.</para>
        /// </param>
        ...
        /// <param name="Pm">
        ///     Valid values for the first (and any additional parameters) are:
        ///         <para>0  ⇒  only respond to explicit host requests (DECRQLP).  Default. It also cancels any filter rectangle.</para>
        ///         <para>1  ⇒  report button down transitions.</para>
        ///         <para>2  ⇒  do not report button down transitions.</para>
        ///         <para>3  ⇒  report button up transitions.</para>
        ///         <para>4  ⇒  do not report button up transitions.</para>
        /// </param>
        /// <returns></returns>
        ...
        ///         <para>1  ⇒  Bold.</para>
        ///         <para>2  ⇒  Faint.</para>
        ///         <para>3  ⇒  Italicized.</para>
        ///         <para>4  ⇒  Underlined.</para>
        ///         <para>5  ⇒  Blink.</para>
        ///         <para>7  ⇒  Inverse.</para>
        ///         <para>8  ⇒  Invisible.</para>
        ///         <para>9  ⇒  Crossed-out characters.</para>
        ///         <para>2 1  ⇒  Doubly-underlined.</para>
        ///         <para>3 0  ⇒  Foreground color.</para>
        ///         <para>3 1  ⇒  BackgroundBrush color.</para>
        ...
        /// <param name="bottom">Bottom line. Default is last line in active page</param>
        /// <param name="right">Right column. Default is last column in active page</param>
        public static string ReportSelectedGfxRend(string top, string left, string bottom, string right) =>
        ...
        /// </summary>
        /// <param name="Ps">
        ///     <para>0  ⇒  80 columns, default if Ps omitted.</para>
        ///     <para>80  ⇒  80 columns.</para>
        ///     <para>132  ⇒  132 columns.</para>
        /// </param>
        ...
        /// </summary>
        /// <param name="Ps">
        ///     <para>Valid values for the parameter are:</para>
        ///         Ps => 0 , 1 or omitted ⇒  transmit a single DECLRP locator report.
        ///     
        ///     <para>If Locator Reporting has been enabled by a DECELR, xterm will respond with a DECLRP Locator Report.  This report is also
        ///     generated on button up and down events if they have been enabled with a DECSLE, or when the locator is detected outside
        ///     of a filter rectangle, if filter rectangles have been enabled with a DECEFR.</para>
        ///     
        ...
        /// </summary>
        public static string PopVideoAttr => "\x1b[#}"; // CSI # }
