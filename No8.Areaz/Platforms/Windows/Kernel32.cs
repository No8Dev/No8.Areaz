...
public static partial class Windows
{
    public static class Kernel32
    {
        ...
        [DllImport("kernel32.dll", SetLastError = true)]
        internal static extern int ResizePseudoConsole(IntPtr hConsole, Windows.Coord size);
        ...
        internal static extern bool GetConsoleCursorInfo(
            IntPtr                consoleOutput,
            out Windows.ConsoleCursorInfo consoleCursorInfo);
        ...
        [DllImport("kernel32.dll", SetLastError = true)]
        internal static extern Windows.Coord GetConsoleFontSize(
            IntPtr consoleOutput,
            int    font);

        // http://pinvoke.net/default.aspx/kernel32/GetConsoleHistoryInfo.html
        [DllImport("kernel32.dll", SetLastError = true)]
        internal static extern bool GetConsoleHistoryInfo(out Windows.ConsoleHistoryInfo consoleHistoryInfo);
        ...
        internal static extern bool GetConsoleScreenBufferInfo(
            IntPtr                      consoleOutput,
            out Windows.ConsoleScreenBufferInfo consoleScreenBufferInfo);
        ...
        internal static extern bool GetConsoleScreenBufferInfoEx(
            IntPtr                        consoleOutput,
            ref Windows.ConsoleScreenBufferInfoEx consoleScreenBufferInfo);

        // http://pinvoke.net/default.aspx/kernel32/GetConsoleSelectionInfo.html
        [DllImport("kernel32.dll", SetLastError = true)]
        internal static extern bool GetConsoleSelectionInfo([Out] out Windows.ConsoleSelectionInfo consoleSelectionInfo);
        ...
        internal static extern bool GetCurrentConsoleFont(
            IntPtr              consoleOutput,
            bool                maximumWindow,
            ref Windows.ConsoleFontInfo consoleCurrentFont);
        ...
        internal static extern bool GetCurrentConsoleFontEx(
            IntPtr                consoleOutput,
            bool                  maximumWindow,
            ref Windows.ConsoleFontInfoEx consoleCurrentFont);

        // http://pinvoke.net/default.aspx/kernel32/GetLargestConsoleWindowSize.html
        [DllImport("kernel32.dll", SetLastError = true)]
        internal static extern Windows.Coord GetLargestConsoleWindowSize(IntPtr consoleOutput);
        ...
        internal static extern bool PeekConsoleInput(
            IntPtr              consoleInput,
            [Out] Windows.InputRecord[] buffer,
            uint                length,
        ...
        internal static extern bool ReadConsole(
            ...
            ref Windows.ReadConsoleControl readConsoleControl);
        ...
        internal static extern bool SetConsoleDisplayMode(
            ...
            out Windows.Coord          newScreenBufferDimensions);

        // http://pinvoke.net/default.aspx/kernel32/SetConsoleHistoryInfo.html
        [DllImport("kernel32.dll", SetLastError = true)]
        internal static extern bool SetConsoleHistoryInfo(Windows.ConsoleHistoryInfo consoleHistoryInfo);
        ...
        internal static extern bool SetConsoleScreenBufferInfoEx(
            IntPtr                        consoleOutput,
            ref Windows.ConsoleScreenBufferInfoEx consoleScreenBufferInfoEx);
        ...
        internal static extern bool SetConsoleWindowInfo(
            IntPtr             consoleOutput,
            bool               absolute,
            [In] ref Windows.SmallRect consoleWindow);
        ...
        internal static extern bool SetCurrentConsoleFontEx(
            IntPtr                consoleOutput,
            bool                  maximumWindow,
            ref Windows.ConsoleFontInfoEx consoleCurrentFontEx);
        ...
        internal static extern bool CreateProcess(
            ...
            ref Windows.SecurityAttributes      lpProcessAttributes,
            ref Windows.SecurityAttributes      lpThreadAttributes,
            bool                        bInheritHandles,
            uint                        dwCreationFlags,
            IntPtr                      lpEnvironment,
            string                      lpCurrentDirectory,
            [In] ref Windows.StartupinfoEx      lpStartupInfo,
            out      Windows.ProcessInformation lpProcessInformation);
        ...
        private static extern bool ReadConsoleOutput(
            ...
            [Out] Windows.CharInfo[] lpBuffer,
            Windows.Coord            dwBufferSize,
            Windows.Coord            dwBufferCoord,
            ref Windows.SmallRect    lpReadRegion
        );

        [DllImport("kernel32.dll", EntryPoint = "WriteConsoleOutput", SetLastError = true, CharSet = CharSet.Unicode)]
        public static extern bool WriteConsoleOutput(
            IntPtr        hConsoleOutput,
            Windows.CharInfo[]    lpBuffer,
            Windows.Coord         dwBufferSize,
            Windows.Coord         dwBufferCoord,
            ref Windows.SmallRect lpWriteRegion
        );
        ...
        public static extern bool ScrollConsoleScreenBuffer(
            IntPtr             consoleOutput,
            [In] ref Windows.SmallRect scrollRectangle,
            IntPtr             clipRectangle,
            Windows.Coord              destinationOrigin,
            [In] ref Windows.CharInfo  fill);
